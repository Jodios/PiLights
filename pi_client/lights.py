import websocket, json, subprocess, shlex, time
from sys import argv
from commands.setup import clear, allWhite, fillColorString, randomize

url = "ws://173.255.202.70:30421/ws"
process = None
...
def run(script):
    ...
    log(scriptArgs)
    procHandle = subprocess.Popen(scriptArgs, stdout=stdOutputHandle, stderr=errOutputHandle)
    return procHandle
